...
##Written by sj2842
# this has 1 good caption and 10 details and rest from the baseline model
def story(z, image_loc, k=100, bw=50, lyric=False):
    ...
    #pipeline broken to add the good caption and details here 
    f3 = open('/Users/shreyajain/Downloads/input_story.txt').read()
    text = f3.split('\n')
    #print text
